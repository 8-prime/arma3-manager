...
public class ConfigConstants
{
    public const string DefaultConfig = """
                                        ...
                                        passwordAdmin	= "passwd";		// Password to login as admin. Open the chat and type: #login password
                                        maxPlayers		= 16;	// Maximum amount of players, including headless clients. Anybody who joins the server is considered a player, regardless of their role or team.
                                        ...
                                        vonCodecQuality	= 11;	// Supports range 1-30, the higher the better sound quality, the more bandwidth consumption:
